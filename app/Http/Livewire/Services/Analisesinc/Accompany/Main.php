...
namespace App\Http\Livewire\Services\Analisesinc\Accompany;
...
class Main extends Component
{
    ...
    public function checkOpen()
    {
        ...
        if ($check) {
            ...
            $this->emit('open_analise_inc', ['productionId' => $check->id, 'noteId' => $check->note_id]);
    ...
    {
        $this->emit('open_analise_inc', $this->analise);
        $this->dispatchBrowserEvent('showModal', [
            'id' => 'analise_form',
        ]);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.services.analisesinc.accompany.main', [
            'lists' => $this->lists,
        ]);
    }
}
