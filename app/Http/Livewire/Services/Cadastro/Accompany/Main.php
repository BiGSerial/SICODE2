...
namespace App\Http\Livewire\Services\Cadastro\Accompany;
...
class Main extends Component
{
    ...
    public function checkOpen()
    {
        ...
        if ($check) {
            ...
            $this->emit('open_analise_cadastro', ['productionId' => $check->id, 'noteId' => $check->note_id]);
    ...
    {
        $this->emit('open_analise_cadastro', $this->analise);
        $this->dispatchBrowserEvent('showModal', [
            'id' => 'analise_form',
        ]);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.services.cadastro.accompany.main', [
            'lists' => $this->lists,
        ]);
    }
}
