...
namespace App\Http\Livewire\Services\Oexterno\Forms;
...
class Analise extends Component
{
    ...
    public function openAnalise($data)
    {
        ...
        if($this->analise) {
            ...
            $this->protocol = $this->analise->protocol;
    ...
    public function gerarCarta($res, $sub)
    {
        ...
        Em atenção à solicitação de V.Sª., informamos que não foi possível dar sequência no protocolo solicitado, pelo seguinte motivo: 
        O endereço informado se encontra em Unidade de Conservação/Zona de Amortecimento Estadual {$this->reserva} e, conforme Resolução Normativa ANEEL n° 1000/2021, em seu artigo 67:          
    ...
    {
        return view('livewire.services.oexterno.forms.analise');
    }
}
