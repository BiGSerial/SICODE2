...
class BlockEvaluator
{
    ...
    public function evaluate(Note $note, Service $service): array
    {
        ...
        if (!$prod->completed) {
            ...
            return $this->res(self::HOLD_BLUE, false, 'producao_em_andamento', $prod);
        }
        ...
        if ($wf) {
            ...
            if ($wfMark && !$prod->partial) {
                ...
                if ($prod->created_at > $wfMark) {
                    return $this->res(self::HOLD_RED, false, 'workform_producao_fechada_posterior_ao_workform', $prod);
                }
            }
