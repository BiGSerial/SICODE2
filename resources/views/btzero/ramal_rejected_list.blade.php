    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-light px-3 py-2  my-1 rounded-3">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">BTZERO</li>
                <li class="breadcrumb-item active" aria-current="page">SMC REJEITADOS</li>
            </ol>
        </ol>
    </nav>
@endsection
...
@section('menu')
    @livewire('btzero.menu', key('menu'))
@endsection

@section('content')
    @livewire('btzero.ramal-rejecteds', key('ramal-rejecteds'))
@endsection
