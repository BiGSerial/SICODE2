    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-light px-3 py-2  my-1 rounded-3">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Pilha {{ $service->service }}</li>
            </ol>
        </ol>
    </nav>
@endsection
...
@section('menu')
    ...
    @include('dispatchs.comissionamento.menu');
@endsection

@section('content')
    @livewire('dispatchs.comission.main', ['service' => $service->uuid])
    @livewire('components.modal.citymodal')
@endsection
