...
<body class="g-sidenav-show edp-bg-gray">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center edp-bg-violeta-100">
            ...
            <ul class="d-flex align-items-center">
                ...
                @if (!Auth()->User()->contract)
                    ...
                    <div class="d-flex align-items-end justify-content-between mx-2">
                        <a href="{{ route('company') }}" class="d-flex align-items-end">
                ...
                @else
                    ...
                    <div class="d-flex align-items-end justify-content-between mx-2">
                        <a href="{{ route('company') }}" class="d-flex align-items-end">
                            ...
                            <span class="d-none d-lg-block text-white fw-bold fs-4">sicode</span>
                        </a>
                    </div><!-- End Logo -->
                @endif
