...
<head>
    ...
    <link href="{{ asset('assets/vendor/boxicons/css/boxicons.min.css') }}?v={{ $version->appver }}" rel="stylesheet">
    <link href="{{ asset('assets/vendor/quill/quill.snow.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/vendor/quill/quill.bubble.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/vendor/remixicon/remixicon.css') }}?v={{ $version->appver }}" rel="stylesheet">
            ...
            <ul class="d-flex align-items-center">
                ...
                @if (!Auth()->User()->contract)
                    {{-- <li class="nav-item mx-2">
                        <a href="" class="logo d-flex mx-0">
                            ...
                            <span class="d-none d-lg-block text-white">sicode</span>
                        </a>
                    </li> --}}
                ...
                @else
                    {{-- <li class="nav-item mx-2">
                        <a href="" class="logo d-flex mx-0">
                            <span
                                class="d-none d-lg-block text-white">{{ Auth()->user()->Company?->name ? mb_strtolower(explode(' ', Auth()->user()->Company->name)[0]) : '' }}</span>
                            <span class="d-none d-lg-block text-white">sicode</span>
                        </a>
                    </li> --}}
                    <li class="nav-item mx-2"><div class="d-flex align-items-end justify-content-between">
