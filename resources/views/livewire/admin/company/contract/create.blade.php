            ...
            <div class="col-lg-7">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-header bg-white d-flex align-items-center justify-content-between">
                        ...
                        <span class="badge text-bg-light">Novo</span>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label">Empresa</label>
                            <select wire:model.defer="company_s" class="form-select">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                <div class="form-check form-switch">
                                    <input wire:model="service" class="form-check-input" type="checkbox" id="service">
                                    <label class="form-check-label" for="service">Serviços</label>
                                </div>
                                <div class="form-check form-switch">
                                    <input wire:model="construction" class="form-check-input" type="checkbox" id="construction">
                ...
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="small text-muted mt-3">
                            As atividades liberadas no contrato serao usadas como base no cadastro dos usuarios dessa empresa.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            @forelse ($services_l as $activity)
                                <div class="col-md-6 col-xl-4" wire:key="contract_create_activity_{{ $activity->id }}">
                                    <div class="border rounded-2 p-3 h-100 bg-white">
                                        <div class="d-flex align-items-start gap-2">
                                            <input class="form-check-input mt-1" type="checkbox" value="{{ $activity->id }}" wire:model="selectedServices" id="activity_create_{{ $activity->id }}">
                                            <div class="flex-grow-1">
                                                <label class="fw-bold mb-1" for="activity_create_{{ $activity->id }}">{{ $activity->service }}</label>
                                        ...
                                        <div class="form-check form-switch mt-3">
                                            <input class="form-check-input" type="checkbox" wire:model.defer="serviceDispatch.{{ $activity->id }}" id="dispatch_create_{{ $activity->id }}" @disabled(!in_array((string) $activity->id, $selectedServices, true) && !in_array($activity->id, $selectedServices, true))>
                                            <label class="form-check-label" for="dispatch_create_{{ $activity->id }}">Permitir despacho</label>
                                        </div>
                                    </div>
                                </div>
                            @empty
