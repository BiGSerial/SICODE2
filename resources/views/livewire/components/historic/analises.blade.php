<div>
    @if ($conclusion)
        <a href="" class="link-secondary fw-bold" data-bs-toggle="modal"
            data-bs-target="#analise-{{ $production->id }}">{{ $conclusion }}</a>



        <!-- Modal -->
        <div class="modal fade" id="analise-{{ $production->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
