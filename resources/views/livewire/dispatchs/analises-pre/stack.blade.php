...
<div>
                            ...
                            <tr wire:key="line-{{ $list->id }}"
                                ...
                                <td class="fw-bold @if ($list->priority) text-danger fw-bold @endif">
                                    ...
                                    @else
                                        ...
                                        <x-legal.note-demand-tags :note-id="$list->note_id" :row-key="'dispatchs-analises-pre-'.$list->id" />
                                    @endif
    ...
    @livewire('dispatchs.common.reclaim-info', key('reclaim-info-analises-pre-stack'))
