...
<div class="survey-main-page">
    ...
    <div class="container-fluid px-3 px-lg-4">
        ...
        <div class="col-12 col-xl-9 d-flex flex-wrap align-items-center justify-content-xl-end gap-2">
            ...
            @livewire('components.filter.filter', ['myKey' => 'region', 'sendFilter' => 'regional', 'model' => 'App\Models\City', 'column' => 'regiao', 'filter' => 'Regiao', 'group_filter' => 'desenho', 'values' => 'regiao', 'direction' => 'ASC', 'query' => ''], key('desenho-region'))
            @livewire('components.filter.filter', ['myKey' => 'regional', 'sendFilter' => 'city', 'model' => 'App\Models\City', 'column' => 'baseConstrucao', 'filter' => 'Regional', 'group_filter' => 'desenho', 'values' => 'baseConstrucao', 'direction' => 'ASC', 'query' => ''], key('desenho-regional'))
            @livewire('components.filter.filter', ['myKey' => 'city', 'sendFilter' => '', 'model' => 'App\Models\City', 'column' => 'rdMunicipio', 'filter' => 'Municipio', 'group_filter' => 'desenho', 'values' => 'municipio', 'direction' => 'ASC', 'query' => ''], key('desenho-city'))
