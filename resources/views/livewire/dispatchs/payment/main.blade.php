            ...
            <div class="card-body p-3 p-lg-4">
                ...
                <div class="filters-row d-flex flex-wrap align-items-center justify-content-end gap-2 mt-3">
                    ...
                    <div class="d-flex flex-wrap justify-content-end gap-2">
                        ...
                        @livewire('components.filter.filter', ['myKey' => 'region', 'sendFilter' => 'regional', 'model' => 'App\Models\City', 'column' => 'regiao', 'filter' => 'Regiao', 'group_filter' => 'payments', 'values' => 'regiao', 'direction' => 'ASC', 'query' => ''], key('region'))
                        @livewire('components.filter.filter', ['myKey' => 'regional', 'sendFilter' => 'city', 'model' => 'App\Models\City', 'column' => 'baseConstrucao', 'filter' => 'Regional', 'group_filter' => 'payments', 'values' => 'baseConstrucao', 'direction' => 'ASC', 'query' => ''], key('regional'))
                        @livewire('components.filter.filter', ['myKey' => 'city', 'sendFilter' => '', 'model' => 'App\Models\City', 'column' => 'rdMunicipio', 'filter' => 'Municipio', 'group_filter' => 'payments', 'values' => 'municipio', 'direction' => 'ASC', 'query' => ''], key('city'))
