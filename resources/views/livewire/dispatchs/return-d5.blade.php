...
<div>
    ...
    <div class="card">
        <div class="card-header  edp-bg-sprucegreen-100 edp-text-verde-dark">
            <h4 class="fs-4 text-uppercase">RETORNO {{ $service->service }} (RI)</h4>
        </div>
                                ...
                                <div class="clear-fix">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            @if (!$list->Production)
                                                <div class="card">
                                                    <h4 class="card-header fs-5 edp-bg-seoweedgreen-100 text-white">
                                                        DADOS
                                                        PARA RETORNO</h4>
                                                    <div class="card-body">
                                                        <div class="clear-fix">
                                                    ...
                                                    <div @click.away="confirm=false">
                                                        ...
                                                        <div class="card border border-secondary border-2"
                                                            x-show="confirm" style="display: none;">
                                                            <div class="card-body">
                                                                <h4 class="text-center fw-bold mb-3">Deseja realmente
                                                                    retornar {{ $list->Note->note }}?</h4>
                                                                <p
                                                                    class="text-justify p-2 border border-1 rounded shadow">
