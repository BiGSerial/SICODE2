...
<div class="supervision-page">
    ...
    <style>
        ...
        .supervision-page .bulk-search-modal .modal-content {
            border: 0;
            border-radius: 0.75rem;
            overflow: hidden;
        ...
        .supervision-page .bulk-search-modal .modal-header {
        ...
        .supervision-page .bulk-search-modal .modal-title {
            font-size: 1rem;
            font-weight: 700;
        }

        .supervision-page .bulk-search-modal textarea {
            min-height: 12rem;
            resize: vertical;
            border-color: #cbd5e1;
        }

        .supervision-page .bulk-search-warning {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-check form-switch mt-3">
                        <input class="form-check-input" type="checkbox" role="switch" id="bulkSearchAnyStatusSupervision"
                            wire:model="bulkSearchAnyStatus">
                        <label class="form-check-label fw-semibold" for="bulkSearchAnyStatusSupervision">
