            ...
            <div class="clear-fix">
                ...
                @elseif (!$lastUser && $service_s)
                    <div class="mb-3">
                        ...
                        <p class="text-justify p-2 border border-1 rounded">Será retornado para o serviço selecionado,
    ...
    <div class="card" x-show="(show1 || (show2 && $service_s))">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center">
                ...
                <button class="btn btn-sm btn-primary mx-2" wire:click.prevent="desagree" x-show="show1">SIM</button>
