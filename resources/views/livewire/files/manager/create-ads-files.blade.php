    ...
    @if ($note)
        <div class="card">
            <div class="card-header edp-bg-sprucegreen-70 text-edp-verde">
                <h4 class="card-title fs-5 my-0 py-0">Upload de Arquivos em Lote para {{ $note->note }} em
                    {{ $service }}</h4>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6 col-xl-4">
                        ...
                        <select class="form-select border-secondary @error('uploadType') is-invalid @enderror"
                            ...
                            @foreach (SelectOptions::getAdsFilesType() as $fileType)
                    ...
                    <div class="mb-3 col-md-6 col-xl-8">
                        <div class="collapse collapse-horizontal" id="showUseType">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control border-secondary @error('files') is-invalid @enderror"
                        ...
                        accept=".jpg,.jpeg,.png,.webp,.pdf,.doc,.docx,.odt,.xls,.xlsx,.xlsm,.ods,.zip"
