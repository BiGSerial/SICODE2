        ...
        @if ($production)
            <div class="card">
                <div class="card-header edp-bg-sprucegreen-70 text-edp-verde">
                    <h4 class="card-title fs-5 my-0 py-0">Upload de Arquivos em Lote para {{ $production->Note->note }}
                        em
                            ...
                            <div class="collapse" id="showUseType">
                                <div class="card card-body">
                                    ...
                                    <p><strong>Exemplo:</strong><br>
                                        Suponha que você tenha 4 arquivos para enviar: 2 de projeto, 1 de ADS e 1 de
                                        Ficha
                                        Técnica de Viabilidade.
                                    </p>
                                    <ol>
                                        <li>Selecione o tipo <strong>‘Projeto’</strong> no campo de Tipo de Envio.</li>
                                        <li>Clique em <strong>Escolher Arquivos</strong> e envie os 2 arquivos de
                                            projeto
                                    ...
                                    <p>
                                        <strong>Importante:</strong> A ordem dos arquivos não é relevante, mas é
                                        fundamental
                                ...
                                @foreach ($tempFiles as $index => $tempFile)
                                    <tr wire:key='{{ $tempFile['file']->getClientOriginalName() }}'>
                                        <td class="text-center align-middle">
                                            <i
                                                class="{{ FileIcon::getIcon($tempFile['ext'])->icon }} fs-4 my-0 py-0"></i>
                                        </td>
                                        <td class="text-center align-middle">
