...
<div>
    <x-show-loading />
    <div class="my-2"> <button type="button" class="btn btn-sm btn-primary"
            onclick="document.getElementById('file-input').click()">ADICIONAR ARQUIVOS</button>
        <button type="button" class="btn btn-sm btn-danger" wire:click.prevent='cancel' wire:loading.attr='disabled'><span
