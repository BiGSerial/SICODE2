                        ...
                        <div class="row">
                            <div class="col-7">
                                ...
                                <div class="card mb-3">
                                    ...
                                    @if ($workReport->Returnwork->count())
                                        <table class="table table-condensed table-sm table-striped-columns">
                                            <tbody>
                                                <tr>
                                    ...
                                    @endif
                                    @if ($workReport->Returnwork->count() > 1)
                                            ...
                                            <div class="col-auto my-0">
                                                <nav aria-label="Page navigation">
                                                    <ul class="pagination pagination-sm justify-content-end">
                                                        ...
                                                        <li class="page-item @disabled($pag == $workReport->Returnwork->count() - 1)"><a
                                                                class="page-link" href="#"
                            ...
                            <div class="col-5">
                                ...
                                @livewire('partner.components.equipments', ['workReport' => $workReport], key('component-equipment'))
