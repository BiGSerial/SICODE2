...
<div wire:ignore.self>
    ...
    <div class="">
            ...
            @if ($notes)
                <div class="card text-bg-danger mx-auto mt-1" style="max-width: 600px;">
                    <div class="card-body text-center">
                        <h5 class="fw-bold">LEMBRE-SE DE INFORMAR APENAS OBRA FINAL</h5>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-condensed">
                        <thead>
                            <tr>
                                ...
                                <th class="fw-bold">Dt Solicitação Ads</th>
        ...
        return !(strpos($order->statusSist, 'ENT') === 0 || strpos($order->statusSist, 'ENC') === 0);
                                    ...
                                    <td class="text-center">
                                        {{ $tNote->TempAdsInfos->isNotEmpty() ? $tNote->TempAdsInfos->last()->sended_at->format('d/m/Y') : '---' }}</span>
                                    </td>
                                    <td class="text-center">
                                        @if ($block)
