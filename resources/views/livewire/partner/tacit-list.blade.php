...
<div>
    ...
    @if (!$lists->count())
        <div class="text-center my-5 py-3">
            <h3>NENHUMA VIABILIDADE À JUSTIFICAR</h3>
        </div>
    @endif
    ...
    @if ($lists->count())
        ...
        <div class="card mb-2 edp-bg-gray">
            <div class="card-header edp-bg-seoweedgreen-100 text-white">
                <div class="row">
                    <div class="col">
                        <h4 class="my-0">VENCIDOS TÁCITAMENTE</h4>
                    </div>
                ...
                <table class="table table-sm table-condensed table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center align-middle">Enviado Em</th>
                            <th scope="col" class="text-center align-middle">Vencido Em</th>
        ...
        return !(strpos($order->statusSist, 'ENT') === 0 || strpos($order->statusSist, 'ENC') === 0);
                                ...
                                <td class="text-center align-middle fw-bold">
                                    {{ Carbon::parse($viab->sended_at)->format('d/m/Y') }}</td>
                                <td class="text-center align-middle text-danger ">
                                    {{ Carbon::parse($viab->tacit_at)->format('d/m/Y') }}</td>
                                <td class="text-center align-middle">
                                    @if ($viab->Engineer)
    ...
    {{-- Livewire Components --}}
    @livewire('partner.actions.tacit-justify', key('tacit-justify'))
