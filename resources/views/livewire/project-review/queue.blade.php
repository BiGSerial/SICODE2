                    ...
                    <tbody>
                        @forelse ($lists as $prod)
                            ...
                            <tr wire:key="pr-queue-row-{{ $prod->id }}">
                                ...
                                @php
                                    $noteType = (int) data_get($prod, 'Note.type_note');
                                    $receivedStatus = $noteType === 2
                                        ? data_get($prod, 'status_note')
                                        : ($noteType === 1 ? data_get($prod, 'centroTrab') : null);
                                    $sapStatus = $noteType === 2
                                        ? data_get($prod, 'Note.nstats')
                                        : ($noteType === 1 ? data_get($prod, 'Note.centerjob') : null);
                                @endphp
                                <td>
                                    <p class="m-0 py-0">
