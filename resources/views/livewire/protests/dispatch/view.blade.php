                 ...
                 @php
                     ...
                     if ($protest->tipoNota == 'OU') {
                         if ($protest->medProtests->where('statusSist' == 'MEDA')->isNotEmpty()) {
                             $dtConclusao = $protest->medProtests->where('statusSist', 'MEDA')->last()
                                 ->dtFimMedidaDesej;
                         } else {
                         ...
                         <tbody>
                             @foreach ($protest->medProtests?->sortByDesc('dtCriacaoMedida') as $medProtest)
                                 ...
                                 <tr class="text-center align-middle {{ $rowClass }}">
                                     ...
                                     <td>
                                         <span
                                             class="badge {{ $badgeClass }} bg-opacity-10 text-{{ str_replace('bg-', '', $badgeClass) }}">{{ $assignment?->ended_at?->format('d/m/Y H:i') ?? 'N/A' }}</span>
                                     </td>
                                     <td>
                                             ...
                                             @if (!$medProtest->completed)
                                                 @if ($resp?->completed)
                                                     ...
                                                     <button class="btn btn-sm btn-outline-danger"
                                                         ...
                                                         wire:click="toReject({{ $medProtest->id }})">
