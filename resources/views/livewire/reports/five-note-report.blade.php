        ...
        <div class="row g-3 mb-3">
            <div class="col-12 col-md-6 col-xl-2">
                <div class="d5r-filter-card">
                    <label class="form-label small text-muted">Despacho de</label>
                    <input type="date" class="form-control border border-secondary" wire:model.lazy="dispatch_from"
                        max="{{ date('Y-m-d') }}">
                </div>
            </div>
            <div class="col-12 col-md-6 col-xl-2">
                <div class="d5r-filter-card">
                    <label class="form-label small text-muted">Despacho até</label>
                    <input type="date" class="form-control border border-secondary" wire:model.lazy="dispatch_to"
                        max="{{ date('Y-m-d') }}">
                </div>
            </div>
            <div class="col-12 col-md-6 col-xl-2">
                <div class="d5r-filter-card">
                    <label class="form-label small text-muted">Conclusão de</label>
                    <input type="date" class="form-control border border-secondary" wire:model.lazy="completed_from"
                        max="{{ date('Y-m-d') }}">
                </div>
            </div>
            <div class="col-12 col-md-6 col-xl-2">
                <div class="d5r-filter-card">
                    <label class="form-label small text-muted">Conclusão até</label>
                    <input type="date" class="form-control border border-secondary" wire:model.lazy="completed_to"
                        max="{{ date('Y-m-d') }}">
                </div>
            </div>
            <div class="col-12 col-md-6 col-xl-2">
