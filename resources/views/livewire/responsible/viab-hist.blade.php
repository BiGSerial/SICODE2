        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-5 d-flex justify-content-end">
                    ...
                    @livewire('components.filter.filter', ['myKey' => 'region', 'sendFilter' => 'city', 'model' => 'App\Models\City', 'column' => 'regiao', 'filter' => 'Regiao', 'group_filter' => 'partner_hist', 'values' => 'regiao', 'direction' => 'ASC', 'query' => ''], key('region'))
                    @livewire('components.filter.filter', ['myKey' => 'city', 'sendFilter' => '', 'model' => 'App\Models\City', 'column' => 'cidade', 'filter' => 'Municipio', 'group_filter' => 'partner_hist', 'values' => 'municipio', 'direction' => 'ASC', 'query' => ''], key('city'))
