...
<div>
    ...
    <div class="card edp-bg-gray">
        <div class="card-header  edp-bg-sprucegreen-100 edp-text-verde-dark">
            <h4 class="fs-4">OBRAS AGUARDANDO DESPACHO</h4>
        </div>
        <div class="card-body py-0 mt-3">
            <div class="mb-3 d-flex flex-wrap align-items-center justify-content-end">
                ...
                <div class="my-2 col-12 col-md-auto ms-2">
                    ...
                    <select name="" id="" class="form-select form-select-sm" wire:model="company_id">
                        <option value="" selected>Empreiteira</option>
        ...
        @if (!$lists)
            <div class="card card-body">
                <h4 class="text-center">SEM OBRAS PARA LIBERAR</h4>
            </div>
        @else
            <div class="row mx-3">
                <div class="col-6">
                ...
                <tbody class="table-group-divider">
                    @if ($lists)
                        @foreach ($lists as $list)
                            @php
                                $dueDate = Carbon::now()->addDays($list->getDays() + 7);
                            @endphp
