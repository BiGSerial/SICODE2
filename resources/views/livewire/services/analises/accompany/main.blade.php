                    ...
                    @else
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-striped table-condensed mb-0">
                                ...
                                <tbody>
                                    @foreach ($lists->sortBy([['priority', 'desc'], ['Note.dt_created', 'asc']]) as $list)
                                            ...
                                            <td class="fw-bold @if ($list->priority) text-danger fw-bold @endif">
                                                ...
                                                <div class="mt-1">
                                                    <x-legal.note-demand-tags
                                                        ...
                                                        :row-key="'services-analises-accompany-'.$list->id"
                                                    />
                                                </div>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-floating">
                                    <select class="form-select" id="bulkConclusion" wire:model="bulkConclusion">
                                        <option value="" selected>Selecione</option>
                                        @foreach (\App\Support\SicodeRules::analysisConclusionOptions() as $value => $label)
