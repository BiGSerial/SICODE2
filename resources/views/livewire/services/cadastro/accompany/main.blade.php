                ...
                @if (!$lists->count())
                    <div class="card-body">
                        <h4 class="text-center">VOCÊ NAO TEM TAREFA ATRIBUÍDA
                            <strong>{{ mb_strtoupper($service->service) }} - @if ($service->Status->count())
                            ...
                            <table class="table table-sm table-striped table-condensed">
                                <thead class="table-dark">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="fw-bold">Em Pausa</th>
                                            ...
                                            <td
                                                ...
                                                <div class="mt-1">
                                                    <x-legal.note-demand-tags
                                                        ...
                                                        :row-key="'services-cadastro-accompany-'.$list->id"
                                                    />
                                                </div>
                                ...
                                ">
                                            ...
                                            <td class="fw-light">
                                                @if ($list->status == '4')
                                                    {{ Carbon::parse($list->updated_at)->diffForHumans() }}
                                                @else
                                                    --
                                                @endif
                                            </td>
        ...
        <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
            <div class="modal-content h-100">
                ...
                <div class="modal-body">
                    @livewire('services.' . $service->folder . '.forms.analise')
                </div>
