...
<div class="user-activity-page external-agency-activity-page">
    <x-show-loading />
    @include('livewire.services.partials.user-activity-list-style')
    @include('livewire.services.partials.user-activity-hero', [
        'context' => 'Tratativas com órgão externo',
        'subtitle' => 'Solicitações encaminhadas e aguardando manifestação da entidade',
        'total' => $lists->total(),
        'accent' => '#0f766e',
    ])
    ...
    <div class="container-fluid">
            ...
            <div class="row g-3 align-items-end">
                <div class="col-12 col-xl-4">
                    <label class="form-label mb-1 d-flex align-items-center justify-content-between">
                        ...
                        <a class="small text-decoration-none" data-bs-toggle="collapse" href="#agencyWildHelp"
                            role="button" aria-expanded="false" aria-controls="agencyWildHelp">
                            Como pesquisar?
                        </a>
                    </label>
                    ...
                    <div class="collapse mt-2" id="agencyWildHelp">
        ...
        <div class="user-activity-table-card position-relative">
            <div class="user-activity-table-header bg-danger d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                <div>
                    <h5 class="user-activity-table-title">
                        <i class="ri-government-line me-2"></i>Aguardando órgão externo
                    </h5>
                    <div class="user-activity-table-subtitle">
                        Tratativas abertas que dependem de retorno ou providência da entidade vinculada.
                    </div>
                </div>
            ...
            <div wire:loading.delay.class.remove="d-none"
                class="position-absolute top-0 start-0 w-100 h-100 d-none external-agency-loading">
            ...
            @if ($lists->isEmpty())
                <div class="external-agency-empty-state">
                    <i class="ri-government-line"></i>
                    <h5>Nenhuma tratativa aguardando órgão externo</h5>
                            ...
                            @foreach ($lists as $i => $ext)
                                @php
                                    ...
                                    $movementClass = match (true) {
                                        $daysAgo === null => 'external-agency-movement--neutral',
                                        $daysAgo > 30 => 'external-agency-movement--danger',
                                        $daysAgo <= 20 => 'external-agency-movement--success',
                                        default => 'external-agency-movement--warning',
                                    };
                                @endphp
                                <tr wire:key="external-agency-{{ $ext->id }}">
                                    <td class="text-muted">
                                    ...
                                    <td>
                                        <div class="external-agency-movement {{ $movementClass }}">
                                            @if ($lastMovement)
...
@push('css')
    <style>
        .external-agency-loading {
            background: rgba(255, 255, 255, .78);
            backdrop-filter: blur(2px);
            z-index: 4;
        }

        .external-agency-empty-state {
            color: var(--activity-muted);
            padding: 3rem 1rem;
            text-align: center;
        }

        .external-agency-empty-state i {
            color: #0f766e;
            display: block;
            font-size: 2.5rem;
            margin-bottom: .75rem;
        ...
        .external-agency-empty-state h5 {
            color: var(--activity-ink);
            font-weight: 600;
        }

        .external-agency-empty-state p {
            margin: 0;
        }

        .external-agency-movement {
            border-radius: .65rem;
            min-width: 8.5rem;
            padding: .55rem .7rem;
        }

        .external-agency-movement strong,
        .external-agency-movement small {
            display: block;
        }
        ...
        .external-agency-movement--danger {
            background: var(--bs-danger-bg-subtle);
            color: var(--bs-danger-text-emphasis);
        }

        .external-agency-movement--warning {
            background: var(--bs-warning-bg-subtle);
            color: var(--bs-warning-text-emphasis);
        }

        .external-agency-movement--success {
            background: var(--bs-success-bg-subtle);
            color: var(--bs-success-text-emphasis);
        }

        .external-agency-movement--neutral {
