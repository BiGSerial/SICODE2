            ...
            <div class="dropdown mx-1">
                ...
                <div class="form-check form-switch mt-3">
                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked"
                        wire:model.bounce.500ms="protocolar" value="20" checked>
                    <label class="form-check-label" for="flexSwitchCheckChecked">PROTOCOLAR
                        <span
                            class="badge rounded-pill text-bg-primary align-middle">{{ $total->where('nstats', 20)->count() }}</span></label>
                </div>
                <div class="form-check form-switch mt-3">
                    <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked"
                        wire:model.bounce.500ms="waiting" value="11" checked>
                    <label class="form-check-label" for="flexSwitchCheckChecked">AGUARDANDO
                        <span
                            class="badge rounded-pill text-bg-warning align-middle">{{ $total->where('nstats', 11)->count() }}</span></label></label>
                </div>
