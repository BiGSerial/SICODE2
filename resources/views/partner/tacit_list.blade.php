    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-light px-3 py-2  my-1 rounded-3">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Vabilidade</li>
                <li class="breadcrumb-item active" aria-current="page">Lista Vencidos Tácitamente</li>
            </ol>
        </ol>
    </nav>
@endsection
...
@section('content')
    @livewire('partner.tacit-list', key('tacit_list'))
@endsection
