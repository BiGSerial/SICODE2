                ...
                <div class="border-start border-3 mb-1 py-0">
                    ...
                    {{-- <li>
                        <a href="{{ route('services.hiringsurvey', ['service' => $service->uuid]) }}"
                            class="nav-item edp-text-verde-dark">
                            <i class="ri-eye-fill fw-light text-white fs-5"> <span>EM VIABILIDADE</span>
                            @livewire('components.count.countnotes', ['service' => $service->uuid], key($service->uuid))
                        </a>
                    </li> --}}
                    ...
                    {{-- <li>
                        <a href="{{ route('services.waiting', ['service' => $service->uuid]) }}"
                            class="nav-item edp-text-verde-dark">
                            <i class="ri-eye-fill fw-light text-white fs-5"> <span>LISTA DE ESPERA</span> @livewire('components.count.countwaiting', ['service' => $service->uuid], key('waiting' . $service->uuid))
                        </a>
                    </li> --}}
                    <li>
