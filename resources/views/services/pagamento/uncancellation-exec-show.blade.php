    ...
    <nav aria-label="breadcrumb" class="py-0 my-0">
        <ol class="breadcrumb bg-light px-3 pt-3 rounded-3">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Medição</li>
                <li class="breadcrumb-item active" aria-current="page">Execução Descancelamento</li>
            </ol>
        </ol>
    </nav>
@endsection
...
@section('content')
    @livewire('services.payment.uncancellation.execution-show', ['service' => $service->uuid, 'request' => $request])
@endsection
