...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('/services/{service}')->controller(ServicesController::class)->name('services.')->middleware('check.service.dispatch:services')   ->group(function () {
        Route::get('/', 'main')->name('main');
    ...
    Route::prefix('/construction/{service}')->controller(ConstructionController::class)->name('construction.')->middleware('check.service.dispatch:services')->group(function () {
        Route::get('/', 'main')->name('main');
        Route::get('/production/{prod}')->name('production');
        Route::get('/to_accompany', 'accompany')->name('accompany');
        Route::get('/my_historic', 'historic')->name('historic');
    ...
    Route::prefix('/dispatch/{service}')->controller(DispatchController::class)->name('dispatch.')->middleware('check.service.dispatch:services')->group(function () {
